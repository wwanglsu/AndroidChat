...
public class BoardListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupChannelname();
        mRef = new Firebase(ChatApplication.FIREBASE_URL).child("channel").child(mChannelName.replace(".", ","));
...
//        getWindowManager().getDefaultDisplay().getSize(size);
        ...
        newBoardValues.put("width", metrics.widthPixels);
        newBoardValues.put("height", metrics.heightPixels);
    ...
    private void openBoard(String key) {
        ...
        intent.putExtra("FIREBASE_URL", mRef.toString());
